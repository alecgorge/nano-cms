...
/* helper function for UTF-8 Slugifyment */
...
function cleanUTF8url ($string) {
	...
	$greekTranslit = array(
		...
		"ρ"=>"r","σ"=>"s","τ"=>"t","υ"=>"y","φ"=>"f","χ"=>"h","ψ"=>"s","ω"=>"w",'ί'=>'i',
		'ϊ'=>'i', 'ϋ'=>'y', 'ΐ'=>'i', 'ΰ'=>'y', 
		'Ά'=>'A', 'Έ'=>'E', 'Ή'=>'H', 'Ί'=>'I', 'Ό'=>'O', 'Ύ'=>'Y', 'Ώ'=>'W', 
		'Ϊ'=>'I', 'Ϋ'=>'Y', 
		'Α'=>'A', 'Β'=>'B', 'Γ'=>'G', 'Δ'=>'D', 'Ε'=>'E', 'Ζ'=>'Z', 
		'Η'=>'H', 'Θ'=>'H', 'Ι'=>'I', 'Κ'=>'K', 'Λ'=>'L', 'Μ'=>'M', 
		'Ν'=>'N', 'Ξ'=>'S', 'Ο'=>'O', 'Π'=>'P', 'Ρ'=>'R', 'Σ'=>'S',
		'Τ'=>'T', 'Υ'=>'Y', 'Φ'=>'F', 'Χ'=>'H', 'Ψ'=>'S', 'Ω'=>'W'
	);
    ...
    $string = mb_str_replace(array('"',"'","^","~",'`'), "", $string);
...
function slugify($title) {
	...
	$pageslug = cleanUTF8url($pageslug);
