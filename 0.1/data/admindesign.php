...
<?php 
	...
	if( !isset($_GET[action]) ) {
		require_once "data/intro.php";	
	}
?>
    </div>
 </div>    
 <div id="footer">&copy; <a href="#">Kalyan Chakravarthy</a> All rights reserved<br>
	powered by <A href='NanoCMS.KalyanChakravarthy.net'>NanoCMS</a>
 </div>
